...
Class tours {
	...
	public function get_MOT_CHOISI(){
		return $this->_MOT_CHOISI;
	}

	public function set_MOT_CHOISI($_MOT_CHOISI){
		$this->_MOT_CHOISI = $_MOT_CHOISI;
	}
	...
	public function createtours(){
        ...
        try {
			...
			$stmt->bindParam(':mot_choisi', $this->_MOT_CHOISI);
